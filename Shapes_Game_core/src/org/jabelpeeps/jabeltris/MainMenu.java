...
//--------------------------------------------MenuLevel 0------------
	private void displayCase0() {
		...
		font.setScale(0.3f);
		if ( buttonCentre("[GOLD]Quick Start[]", 22) ) core.setScreen(new ChallengeLevel3(false));
...
//--------------------------------------------------------------------
	...
	private void runSavedLevel() {
		...
		try {
			Class<?> level = ClassReflection.forName("org.jabelpeeps.jabeltris.levels." + loaded.getString("level"));
