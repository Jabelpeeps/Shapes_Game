...
import org.jabelpeeps.jabeltris.shapes.LineBlue;
import org.jabelpeeps.jabeltris.shapes.LineGreen;
import org.jabelpeeps.jabeltris.shapes.LineRed;
import org.jabelpeeps.jabeltris.shapes.LineYellow;
...
// ---------------------------------------------Methods----------
	...
	public Shape makeNewShape(int x, int y) {
		...
		switch (option) {
			case 1:                       
				newShape = new LineRed();
				break;
			case 2:                       
				newShape = new LineBlue();
				break;
			case 3:                       
				newShape = new LineYellow();				
				break;
			case 4:
				newShape = new LineGreen();
				break;
		}
